...
sur la grille R.486 A (base + option PE). Matching par libelle normalise. Relancable."""
...
CRITERES = {
    ...
    "Positionner la plate-forme sous une paroi plane horizontale": "Donne des à-coups injustifiés / Ne peut pas atteindre l'endroit exact / N'utilise pas efficacement les possibilités de la PEMP",
    "Positionner la PEMP sous une paroi plane horizontale": "Donne des à-coups injustifiés / Ne peut pas atteindre l'endroit exact / N'utilise pas efficacement les possibilités de la PEMP",
    ...
    "Déplacer la plate-forme sous une paroi plane horizontale": "Donne des à-coups injustifiés / Ne peut pas atteindre l'endroit exact",
    "Positionner la plate-forme à un emplacement précis en élévation": "N'utilise pas efficacement les possibilités de la PEMP et pas dans le temps imparti",
...
db.commit()
print("[OK] R.486 A : %s criteres ecrits, %s manquants" % (nb_ok, nb_miss))
