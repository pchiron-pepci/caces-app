...
def init_data():
    ...
    try:
        ...
        print("Initialisation des donnees PEPCI...")
        ...
        db.add_all([r482, r484, r485, r486, r489])
        db.flush()
        ...
        categories = [
            ...
            # R489
            Categorie(famille_id=r489.id, code="1A",  libelle="Transpalettes a conducteur porté",         ut_pratique=0.5,  pepci_habilite=False),
