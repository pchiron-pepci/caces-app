...
sur la grille R.482 G (base CH+PC + option TEL). Le porte-engins etant DANS la base
du G, ses criteres d'echec sont integres au bloc 'base'. Matching par libelle normalise.
