...
sur la grille R.482 C2 (base nivellement + options PE + TEL). Matching par libelle normalise.
...
CRITERES = {
    "base": [
        ...
        ('Executer un deblai / remblai', 'Creuse le sol lors du rassemblement des materiaux / Ne parvient pas a faire un devers homogene'),
    ],
    "PE": [
