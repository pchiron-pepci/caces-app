"""Peuple la grille d'evaluation pratique de l'OPTION Porte-engins (PE) de R.486 B.
...
grille = GrillePratique(
    recommandation="R.486", categorie="B", type="option", code_option="PE",
...
db.commit()
print("[OK] Grille R.486 B option PE creee (id=%s), total %s (attendu 50)" % (grille.id, total))
