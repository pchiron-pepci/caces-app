...
sur la grille R.482 E (base tombereau + options PE + TEL). Matching par libelle normalise.
...
CRITERES = {
    "base": [
        ...
        ('Positionner le tombereau pour le chargement', "Le tombereau n'est pas place de sorte que l'engin de chargement puisse repartir les materiaux dans la benne"),
        ('Effectuer un parcours test en montant les vitesses et en utilisant correctement les dispositifs de freinage', "N'utilise pas toutes les vitesses / Perd le controle de l'engin / Heurte un obstacle"),
        ('Positionner le tombereau pour le dechargement et vider la benne', 'Ne vide pas la benne en totalite / Une partie des materiaux est dechargee en dehors de la zone prevue'),
    ],
    "PE": [
