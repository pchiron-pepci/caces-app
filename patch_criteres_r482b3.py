...
sur la grille R.482 B3 (base rail-route + options PE + TEL). Matching par libelle normalise.
...
CRITERES = {
    "base": [
        ...
        ("Verifier la presence et l'etat des accessoires de levage", 'Ne verifie pas les accessoires de levage'),
        ('Verifier le bon fonctionnement des mecanismes de montee / descente des lorries', 'Ne procede pas aux essais'),
        ('Verifier le bon fonctionnement du groupe de secours', "Ne s'assure pas du fonctionnement du groupe de secours"),
        ('Circuler a vide et en charge, en marche avant / en marche arriere, en ligne droite / en virage, en mode route / en mode rail', 'Donne des a-coups injustifies / Ne parvient pas a adapter ses trajectoires / Heurte un obstacle / Roule en dehors du chemin'),
        ("Effectuer en securite les manoeuvres de montee / descente de banquette et d'enraillement / deraillement", "La pelle n'est pas parallele aux rails au moment de l'enraillement"),
        ("Effectuer l'operation de levage (prise, circulation en charge et depose d'une charge au sol)", "Les moyens d'elingage choisis sont inadequats / L'angle d'elingage n'est pas conforme a la tolerance de l'accessoire / La stabilite de l'engin est compromise lors du levage"),
    ],
    "PE": [
