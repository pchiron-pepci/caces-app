...
Porte-engins (PE) seule, 0,5 UT, note_max 50, seuil 35. Pas de TEL (integree dans la variante CA).
Source : feuille Excel OTC 'Pratique B2'. Idempotent.
"""
import os
...
for code, libelle, ordre_opt, themes in OPTIONS:
    ...
    grille = GrillePratique(
        recommandation="R.482", categorie="B2", type="option", code_option=code,
