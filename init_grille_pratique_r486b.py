"""Peuple la grille d'evaluation pratique R.486 categorie B (base).
Source : fiche INRS + feuille Excel OTC 'Pratique B'. Idempotent.
"""
import os
...
THEMES = [
    ("Prise de poste et mise en service (1B ou 3B)", 15, [
        ("1", None, [
    ...
    ("Mise en place, conduite et manœuvres (1B)", 35, [
        ("4", None, [
            ("Baliser la zone d'intervention", 2),
            ("Déployer les stabilisateurs", 2),
            ("Régler l'horizontalité de la PEMP", 2),
            ("Replier les stabilisateurs", 2),
        ]),
        ("5", None, [
        ...
        ("6", None, [
            ...
            ("Positionner la plate-forme sous ou au-dessus d'une paroi plane horizontale", 3),
            ("Positionner la plate-forme dans un espace limité", 3),
            ("Effectuer les manoeuvres de secours (au moyen des commandes de secours et de dépannage)", 3),
        ]),
    ]),
    ("Manœuvres et conduite (3B)", 34, [
        ("7", None, [
        ...
        ("8", None, [
            ...
            ("Circuler plate-forme en position haute (4 m mini), dans le sens de la marche, en marche avant / arrière, en ligne droite / en virages", 3),
            ("Circuler plate-forme en position haute (4 m mini), dans le sens inverse de la marche, en marche avant / arrière, en ligne droite / en virages", 3),
            ("Circuler plate-forme en position haute (4 m mini), perpendiculairement au sens de marche, en marche avant / arrière, en ligne droite / en virages", 3),
            ("Positionner la PEMP le long d'une paroi plane verticale", 2),
            ("Déplacer la plate-forme le long d'une paroi plane verticale", 2),
            ("Déplacer la plate-forme sous ou au-dessus d'une paroi plane horizontale", 3),
            ("Positionner la plate-forme dans un espace limité", 3),
            ("Effectuer des manœuvres de secours (au moyen des commandes de secours et de dépannage)", 3),
        ]),
    ]),
    ("Fin de poste (1B ou 3B)", 10, [
        ("9", None, [
...
grille = GrillePratique(
    recommandation="R.486", categorie="B", type="base", code_option=None,
    libelle="PEMP a elevation multidirectionnelle (types 1 et 3)",
...
db.commit()
print("[OK] Grille R.486 B base creee (id=%s)" % grille.id)
