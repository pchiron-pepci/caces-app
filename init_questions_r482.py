...
TEXTES_GRILLE = {
    1: {
        1: [
            ...
            "Le signaleur doit posseder une autorisation de conduite",
            "Le chef de chantier doit veiller a la securite de ses equipes",
            "L'inspecteur du travail veille au respect du droit du travail",
            "Les controleurs de la Carsat peuvent infliger des amendes administratives",
            "Une pelle hydraulique de masse superieure a 6000 kg appartient a la categorie B1 de la recommandation CACES R.482",
            "Une petite niveleuse appartient a la categorie A de la recommandation CACES R.482",
        ],
        2: [
            "[1] est le balancier",
            "Cette niveleuse est equipee d'un scarificateur",
            "La foreuse est un engin a deplacement alternatif",
            "La masse en service de l'engin est indiquee sur la plaque constructeur",
            "Un moteur utilise sans filtre a air s'use prematuremenent",
            "Ce verin situe sur le balancier de la pelle permet le mouvement du godet",
            ...
            "L'utilisation d'equipements interchangeables ne necessite pas de formation particuliere",
