...
sur la grille R.482 C3 (base nivellement + options PE + TEL). Matching par libelle normalise.
...
CRITERES = {
    "base": [
        ...
        ("Realiser le reglage d'une plate-forme", "Plus de 50 % de la surface n'est pas plane"),
        ("Realiser le reglage d'un talus ou un fosse avec la lame deportee", 'Ne parvient pas a faire un devers homogene'),
    ],
    "PE": [
