"""Peuple la grille d'evaluation pratique de l'OPTION Telecommande (TEL) de R.482 G.
La cat G EST le porte-engins -> AUCUNE option PE, seulement TEL (0,5 UT, note_max 50, seuil 35).
Source : feuille Excel OTC 'Pratique G'. Idempotent.
"""
import os
...
for code, libelle, ordre_opt, themes in OPTIONS:
    ...
    grille = GrillePratique(
        recommandation="R.482", categorie="G", type="option", code_option=code,
